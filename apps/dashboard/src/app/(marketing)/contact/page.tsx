      ...
      <section className="section">
        <div className="wrap cols3">
          ...
          <div className="card office">
            ...
            <div className="row"><span className="oi"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z" /><circle cx="12" cy="10" r="3" /></svg></span><div><b>mkEngage</b><p>C-98 B, 2nd Floor, Phase 7,<br />Industrial Area, Sector 73,<br />Sahibzada Ajit Singh Nagar,<br />Punjab 160055</p></div></div>
            <div className="row"><span className="oi"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.6A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.4 2.5 1.2 4 .7 4.9L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3c.9-.5 2.4.3 4.9.7a2 2 0 0 1 1.7 2z" /></svg></span><div><b>Phone</b><p>+91 98887 72736</p></div></div>
